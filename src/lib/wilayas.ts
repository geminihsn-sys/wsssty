/**
 * The 58 wilayas (provinces) of Algeria, following the 2019/2021
 * administrative reorganization. Used in the checkout wilaya selector and to
 * label orders in the admin dashboard.
 */
...
export function wilayaLabel(code: number, lang: "fr" | "ar"): string {
